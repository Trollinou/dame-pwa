...
- **Parcours Pédagogique & Cours Assignés** : Distinction claire entre la section « 📌 Cours assignés » (*« Prescrits par vos entraîneurs »*, immédiatement déverrouillés sans prérequis séquentiel) et les cours généraux du « 📚 Parcours du Club » (progression linéaire).
